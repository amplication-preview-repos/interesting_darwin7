...
import { CreatePostAnalyticsArgs } from "./CreatePostAnalyticsArgs";
import { UpdatePostAnalyticsArgs } from "./UpdatePostAnalyticsArgs";
...
export class PostAnalyticsResolverBase {
  ...
  async createPostAnalytics(
    @graphql.Args() args: CreatePostAnalyticsArgs
  ): Promise<PostAnalytics> {
  ...
  async updatePostAnalytics(
    @graphql.Args() args: UpdatePostAnalyticsArgs
  ): Promise<PostAnalytics | null> {
    try {
